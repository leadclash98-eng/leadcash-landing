...
const team = [
  {
    ...
    role: "Founder",
    bio: "7+ years in digital marketing, specializing in B2B lead generation, LinkedIn, cold outreach, social media growth, and brand development.",
    initials: "YD",
  },
  {
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {industries.map((industry, i) => (
              <AnimateIn key={industry} delay={i * 0.1}>
                <span className="px-6 py-3 rounded-full bg-white border border-border/50 text-sm font-semibold hover:border-primary hover:text-primary transition-all duration-300 card-shadow cursor-pointer">
                  {industry}
                </span>
              </AnimateIn>
            ))}
